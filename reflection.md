...
To my knowledge, all of my code is working as instructed in the files and provided README. I think inefficiencies in my code could come from tracking the distance of nodes in the nodes itself because each time you are updating it, you are updating the node. For the rest of the algorithm, it seems like it would run as efficiently as the other examples provided for a standard Dijkstra's algorithm.
